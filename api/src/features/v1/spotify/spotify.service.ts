...
export const fetchSongsByActivity = async (accessToken: string, startActivityDate: Date, endActivityDate: Date) => {
	...
	filteredSongsByEndDate.sort((a, b) => new Date(a.played_at).getTime() - new Date(b.played_at).getTime());
