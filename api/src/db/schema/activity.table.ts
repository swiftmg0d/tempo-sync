...
import { bigint, decimal, json, pgTable, timestamp, varchar } from 'drizzle-orm/pg-core';
...
import { EffortCamal, GearCamal, LapCamal, SplitMetricCamal, SplitStandardCamal } from '@/types/strava.type';
