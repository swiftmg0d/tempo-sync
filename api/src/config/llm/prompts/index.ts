import { SYSTEM_PROMPT_HEARTBEAT_SONG_ANALYSIS, USER_PROMPT_HEARTBEAT_SONG_ANALYSIS } from './spotify/songs-heartrate-insight.promp';
import { SYSTEM_PROMPT_ACTIVITY_DESCRIPTION, USER_PROMPT_ACTIVITY_DESCRIPTION } from './strava/activity-description.prompt';
import { SYSTEM_PROMPT_ACTIVITY_INSIGHT, USER_PROMPT_ACTIVITY_INSIGHT } from './strava/activity-insight.promp';
